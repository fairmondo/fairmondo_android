...
import de.handler.mobile.android.fairmondo.data.datasource.database.Category;
import de.handler.mobile.android.fairmondo.data.datasource.database.Product;
import de.handler.mobile.android.fairmondo.data.datasource.database.SearchSuggestion;
...
public class DatabaseController {
    ...
    @Background
    public void setSearchSuggestions(ArrayList<de.handler.mobile.android.fairmondo.data.businessobject.Product> products, String categoryString) {
        if (products != null) {
            for (de.handler.mobile.android.fairmondo.data.businessobject.Product product : products) {
                if (product != null) {
    ...
    @Background
    public void setProducts(ArrayList<de.handler.mobile.android.fairmondo.data.businessobject.Product> articles) {

        for (de.handler.mobile.android.fairmondo.data.businessobject.Product product : articles) {
